defmodule NewsbloatWeb.SidebarMenuComponent do
  ...
  def render(assigns) do
    ...
    ~L"""
    <section x-data="{ isOpen: false }" x-bind:class="isOpen ? 'bg-background w-64 shadow-lg h-screen overflow-y-auto pb-16' : 'bg-transparent w-0'" class="fixed top-0 p-4 z-10">
